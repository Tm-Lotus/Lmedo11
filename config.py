...
START_IMG_URL = getenv("START_IMG_URL", "https://graph.org/file/6e27fa6d9ecfceaf2ed36.jpg")

PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "https://graph.org/file/6e27fa6d9ecfceaf2ed36.jpg",
)

PLAYLIST_IMG_URL = "https://graph.org/file/6e27fa6d9ecfceaf2ed36.jpg"
...
if PING_IMG_URL:
    if PING_IMG_URL != "assets/Ping.jpeg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://graph.org/file/6e27fa6d9ecfceaf2ed36.jpg"

if START_IMG_URL:
    if START_IMG_URL != "assets/Ping.jpeg":
        if not re.match("(?:http|https)://", START_IMG_URL):
            START_IMG_URL = "https://graph.org/file/6e27fa6d9ecfceaf2ed36.jpg"
